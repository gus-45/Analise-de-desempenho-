...
- **TesteInsercao.java** 
  Rodar apenas testes de inserção (útil para debug e ajustes de parâmetros).

- **TesteBusca.java** 
  Rodar apenas testes de busca em uma estrutura escolhida (Vetor / ArvoreBinaria / ArvoreAVL).

- **TesteOrdenacao.java** 
  Rodar comparativo entre BubbleSort e MergeSort isoladamente.
...
1. Abra terminal e entre na pasta do projeto:
```bash
